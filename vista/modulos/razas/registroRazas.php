<?php include 'menu.php'; ?>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-adjust"></i>Registro de Razas</li>
            </ol>
          </div>
        </div>
  ...
  <strong>Bienvenido!</strong> Aqui puedes registrar las distintas razas de tu granja.
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>
<div id="respuesta">  </div>
                <?php $emple= new razaController();
                    $emple->registrarRaza();
                 ?>
...
<script type="text/javascript">
   ...
   $('#guardar').click(function(){
        ...
        $.ajax({                        
           type: "POST",                 
           url: "../controlador/razaController",                     
           cache: false,
              contentType: false,
           processData: false,
