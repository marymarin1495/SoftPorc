  ...
  <!-- container section start -->
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Celos</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index">Inicio</a></li>
              <li><i class="fa fa-laptop"></i>Registrar de periodos de celo</li>
            </ol>
          </div>
        </div>
       <div class="alert alert-primary alert-dismissible fade show" role="alert">
  <strong>Bienvenido!</strong> registra los periodos de celo de la reproductora.
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>
<div id="respuesta">  </div>
                <?php $emple= new celoController();
                    $emple->registrarCelo();
                 ?>
               <div class="panel-body container">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-6">
                        <select class="form-control " id="size-select" name="porcina"><option value="-1">Seleciona el tipo de monta</option>
                          ...
                          <option value="1">Inseminacion</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Sicronia hormonal<span class="required">*</span></label>
                      <div class="col-lg-6">
                        <select class="form-control " id="size-select" name="porcina"><option value="-1">¿Hay sincronia hormonal?</option>
...
<script type="text/javascript">
   ...
   $('#guardar').click(function(){
        ...
        $.ajax({                        
           type: "POST",                 
           url: "../controlador/celoController",                     
           cache: false,
              contentType: false,
           processData: false,
