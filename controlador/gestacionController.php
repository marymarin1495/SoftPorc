<?php 
class gestacionController{

	public function  registrarGestacion(){
  ...
  <strong>Periodo gestacion agregado!.</strong>
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
	...
	public function  listarGestacion(){
           $respuesta=gestacionModel::listarGestacion();
		foreach ($respuesta as $row => $item) {
		    $monta=$item["Id_Monta"];
			echo '<tr id="'.$item["Id_Periodo"].'"> <td>'.$item["Id_Periodo"]. '</td><td>'.$item["Fecha_Inicio"].'</td><td>'.$monta.'</td></tr>';
		}
	}
